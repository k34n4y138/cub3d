...
/*   Updated: 2023/08/14 23:07:34 by zmoumen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 		handl_err_pixl(cub);
// 		arg.x0 = cub->player.x * cub->minimap_scale;
// 		arg.x1 = cub->cast.wal_x * cub->minimap_scale;
// 		arg.y0 = cub->player.y * cub->minimap_scale;
// 		arg.y1 = cub->cast.wal_y * cub->minimap_scale;
// 		arg.color = ft_pixel(173, 216, 230, 120);
// 		draw_line(arg, cub->minimap);
